...
export default function Profile() {
  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData(prev => ({
      ...prev,
      [name]: maskedValue,
      nome: name === 'responsavel' ? maskedValue : prev.nome
    }));
  };
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              >
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    <label className={`text-[10px] font-black uppercase tracking-widest ml-1 flex items-center gap-2 ${isDarkMode ? 'text-blue-400' : 'text-[#0b82ff]'}`}>
                    ...
                    <div className="relative">
                      <Building2 className={`absolute left-3 top-1/2 -translate-y-1/2 ${isDarkMode ? 'text-zinc-700' : 'text-slate-300'}`} size={16} />
                      <input 
                        name="empresa"
