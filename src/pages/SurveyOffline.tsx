        ...
        <div className="flex flex-col gap-6 w-full">
          {availableCampaigns.map((camp, idx) => (
            <motion.button 
              ...
              className="bg-zinc-900 hover:bg-zinc-800 border-2 border-white/5 hover:border-blue-500/30 p-5 rounded-[2rem] text-left transition-all group relative overflow-hidden flex flex-row items-center gap-4"
            >
