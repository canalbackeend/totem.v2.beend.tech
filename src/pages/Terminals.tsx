...
export default function Terminals() {
  ...
  const handleEdit = async () => {
    ...
    toast.promise(
      api.patch(`/terminals/${selectedTerminal.id}`, payload),
      {
                ...
                >
                  <div className="flex flex-col gap-1 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {(isMasterAdmin || isAdmin) && term.company_name && (
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <input 
                            ...
                            placeholder={modalType === 'edit' ? "Deixe em branco para manter a atual" : "Ex: minha-senha-123"}
                            className={`w-full rounded-lg p-3 text-sm font-medium focus:outline-none focus:ring-1 transition-all ${
                              isDarkMode 
                                ? 'bg-black border border-white/5 text-white focus:border-white/20 focus:ring-white/10 placeholder:text-zinc-700' 
                                : 'bg-slate-50 border border-slate-200 text-slate-800 focus:border-[#0b82ff] focus:ring-[#0b82ff]'
                            }`}
                          />
                          {modalType === 'edit' && (
